---
name: orcheo
description: Install Orcheo Python packages and Canvas from PyPI/npm, start Orcheo services with docker compose, and run Orcheo CLI commands. Use when setting up Orcheo from scratch, updating installs, launching production or local stacks via docker compose, or executing `orcheo`/`orcheo-canvas` CLI workflows.
---
...
When the user asks what workflows are available or "what workflows do I have now", run:
